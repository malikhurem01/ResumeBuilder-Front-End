...
const ExperienceForm = ({ handleInputData, handlePDFLoading }) => {
  ...
  }, [experiences, handleInputData, handlePDFLoading]);
                ...
                <Accordion.Body>
                  ...
                  <Row>
                    <Col>
                      ...
                      >
                        <Form.Control
                          value={experiences.set[i]['startingDateInput' + i]}
                          onChange={handleModifyExperience}
                          type="date"
                          placeholder="e.g Business Analyst"
                        />
                    ...
                    <Col>
                      ...
                      >
                        <Form.Control
                          ...
                          disabled={
                            experiences.set[i]['presentWorkSwitch' + i] === 'on'
                              ? true
                              : false
                          }
                          onChange={handleModifyExperience}
                  ...
                  <Form.Check
                    disabled={
                      experiences.set[i]['startingDateInput' + i] ? false : true
                    }
                  ...
                  >
                    ...
                    />
                    <Form.Text muted>
                      Shortly give your job description. Best job descriptions
                      are straight to point without giving much details.
                    </Form.Text>
                  </FloatingLabel>
                  <Button
                    id={i}
